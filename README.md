...
## How to use it 
Add the text of your resume inside resume_text.txt and fill the configuration.file
...
You only need to answer once to the questions then the bot will always put the answer you delivered if the same question is asked on another job offer
...
<img width="884" height="156" alt="image" src="https://github.com/user-attachments/assets/af6b8de5-61b9-4bd9-9bca-b25a4e765e74" />
...
```
job_keyword_list contain all the "job name" you are looking for the bot will loop through each of them to search job and apply
* Apply
...
If you want to see example of cover letter just put print_cover_letter to True inside the configuration file and the bot will send the cover letter and the link of the job offer to discord and he won't apply to the offer
